...
public class Address implements Serializable {
	...
	public Address(String line1, String line2, String line3, String city, String state, int zipCode, String countryCode,
			int separatorAddress0) {
		this.line1 = line1;
		this.line2 = line2;
		this.line3 = line3;
		this.city = city;
	...
	public String toString() {
		return "Address{" + "line1='" + line1 + '\'' + ", line2='" + line2 + '\'' + ", line3='" + line3 + '\''
				+ ", city='" + city + '\'' + ", state='" + state + '\'' + ", zipCode=" + zipCode + ", countryCode='"
				+ countryCode + '\'' + ", separatorAddress0=" + separatorAddress0 + '}';
	}
}