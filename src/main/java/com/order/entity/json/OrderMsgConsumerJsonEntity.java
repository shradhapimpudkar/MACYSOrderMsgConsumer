...
import com.order.dto.json.OrderStatus;

@Entity(name = "ConsumerMsgJson")
public class OrderMsgConsumerJsonEntity implements Serializable {
    ...
    public OrderMsgConsumerJsonEntity() {
